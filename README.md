...
- [Início rápido](#início-rápido)
  - [1. Abrir um pull request e ver o gate agir](#1-abrir-um-pull-request-e-ver-o-gate-agir)
  - [2. Reproduzir a demonstração de shift-left](#2-reproduzir-a-demonstração-de-shift-left)
...
- [Arquivo por arquivo](#arquivo-por-arquivo)
  ...
  - [`.github/workflows/_reusable-test.yml`](#githubworkflows_reusable-testyml)
  - [`README.md`](#readmemd)
...
- [Divergências em relação ao enunciado](#divergências-em-relação-ao-enunciado)
  - [1. Repositório público em vez de privado](#1-repositório-público-em-vez-de-privado)
...
Validação do rollout e do endpoint de saúde:
